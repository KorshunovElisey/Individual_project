...
class MainWindow(QMainWindow):
    ...
    def init_window(self):
        ...
        self.comboBox_camera.currentTextChanged.connect(self._handle_change_device_type)
    ...
    def _handle_start_button(self, value):
        if self.selected_device_type == "Семисегментный":
            ...
            print("Стрелочный режим прибора ещё не поддерживается")  # TODO: add CameraWindowArrow
        return True
